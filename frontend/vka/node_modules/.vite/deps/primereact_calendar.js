...
var Calendar = React3.memo(React3.forwardRef(function(inProps, ref) {
  ...
  var decrementYear = function decrementYear2() {
    var year2 = getViewYear();
    var _currentYear = year2 - 1;
  ...
  var validateDate = function validateDate2(value) {
    if (props.yearNavigator) {
      var _ref3 = props.yearRange ? props.yearRange.split(":").map(function(year2) {
        return parseInt(year2, 10);
      }) : [null, null], _ref4 = _slicedToArray(_ref3, 2), minRangeYear = _ref4[0], maxRangeYear = _ref4[1];
  ...
  var getViewYear = function getViewYear2() {
  ...
  var isPastMaxDateWithBuffer = function isPastMaxDateWithBuffer2() {
    var bufferInSeconds = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 10;
    var now = /* @__PURE__ */ new Date();
    var maxDate = props.maxDate;
    return maxDate < now && Math.abs((now.getTime() - maxDate.getTime()) / 1e3) > bufferInSeconds;
  };
